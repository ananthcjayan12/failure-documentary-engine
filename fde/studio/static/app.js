...
document.addEventListener("click",async event=>{
  ...
  try{
    ...
    if(target.dataset.generateAsset){
      await request(`/api/projects/${encodeURIComponent(state.activeProjectId)}/assets/${encodeURIComponent(target.dataset.generateAsset)}/generate`,{
        method:"POST",
        body:JSON.stringify({target:target.dataset.reviewTarget,force:true})
      });
